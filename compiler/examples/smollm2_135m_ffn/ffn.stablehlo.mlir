module {
  func.func @smollm2_135m_ffn(
      %x: tensor<32x576xbf16>,
      %gate_w: tensor<576x1536xi8>,
      %up_w: tensor<576x1536xi8>,
      %down_w: tensor<1536x576xi8>) -> tensor<32x576xbf16> {
    %x_f = stablehlo.convert %x : (tensor<32x576xbf16>) -> tensor<32x576xf32>
    ...
    %result = stablehlo.convert %down : (tensor<32x576xf32>) -> tensor<32x576xbf16>
    return %result : tensor<32x576xbf16>
  }
}
