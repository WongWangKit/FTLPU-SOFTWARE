module {
  func.func @smollm2_135m_ffn_seq128(
      ...
      %down_w: tensor<1536x576xi8>) -> tensor<128x576xbf16> {
    %x_f = stablehlo.convert %x : (tensor<128x576xbf16>) -> tensor<128x576xf32>
    ...
    %result = stablehlo.convert %down : (tensor<128x576xf32>) -> tensor<128x576xbf16>
