module {
  func.func @w8a16_ffn_128x64x128x64(
      %x: tensor<128x64xbf16>,
      %gate_w: tensor<64x128xi8>,
      %up_w: tensor<64x128xi8>,
      %down_w: tensor<128x64xi8>) -> tensor<128x64xbf16> {
    %x_f = stablehlo.convert %x : (tensor<128x64xbf16>) -> tensor<128x64xf32>
    ...
    %result = stablehlo.convert %down : (tensor<128x64xf32>) -> tensor<128x64xbf16>
    return %result : tensor<128x64xbf16>
  }
}
