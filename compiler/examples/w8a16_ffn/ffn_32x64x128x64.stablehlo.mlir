module {
  func.func @w8a16_ffn_32x64x128x64(
      %x: tensor<32x64xf16>,
      %gate_w: tensor<64x128xi8>,
      %up_w: tensor<64x128xi8>,
      %down_w: tensor<128x64xi8>) -> tensor<32x64xf16> {
    %x_f = stablehlo.convert %x : (tensor<32x64xf16>) -> tensor<32x64xf32>
    ...
    %result = stablehlo.convert %down : (tensor<32x64xf32>) -> tensor<32x64xf16>
