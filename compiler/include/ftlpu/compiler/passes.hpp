...
Module lower_tensor_to_stream(const Module& module, std::size_t south_to_north_tiles = 20);
Module lower_stream_to_schedule(const Module& module, std::size_t south_to_north_tiles = 20);
