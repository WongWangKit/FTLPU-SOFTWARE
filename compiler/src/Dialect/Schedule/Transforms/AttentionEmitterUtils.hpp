...
void emitMxm(mlir::IRRewriter &rewriter, mlir::Location location, int64_t cycle,
             ...
             int64_t weightInnerColumn = 0, llvm::StringRef dataFormat = "fp16",
...
void emitMxmWave(mlir::IRRewriter &rewriter, mlir::Location location,
                 ...
                 int64_t groupCount = 1, int64_t groupInterval = 1,
...
VxmOp emitVxm(mlir::IRRewriter &rewriter, mlir::Location location,
              ...
              llvm::StringRef outputHemisphere, int64_t scaleBinding = -1);
...
void emitRopeOrCast(mlir::IRRewriter &rewriter, mlir::Location location,
                    ...
                    int64_t hemisphere, bool rope, mlir::Value value,
