...
def render(rounds: list[Round], output: Path, lanes: int,
    ...
    lines = [
        ...
        f'<text x="42" y="69" class="sub">seq_len={sequence_length}; shared-SR C2C bandwidth per direction: {lanes} lanes x {bytes_per_lane} B/cycle = {lanes * bytes_per_lane} B/cycle.</text>',
