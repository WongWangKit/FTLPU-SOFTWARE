...
// counters losslessly. Compiler-authored MEM_WRITE_SYNC occupies its reserved
// MEM ICU window; an ordinary SYNC is a one-cycle fetch marker because its
// actual drain time depends on runtime FU completion.
